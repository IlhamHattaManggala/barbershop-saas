<div class="min-h-[85vh] flex items-center justify-center p-4 sm:p-6 font-sans">
    <div class="max-w-md w-full space-y-6">
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl overflow-hidden text-zinc-900 dark:text-white">
            ...
            <!-- Top Status Banner -->
            <div class="bg-rose-600 dark:bg-rose-700 p-6 text-white text-center space-y-2">
                ...
                <h1 class="text-xl font-extrabold tracking-tight">Pembayaran Belum Selesai</h1>
                <p class="text-xs text-rose-100 font-medium">Transaksi via Pakasir Payment Gateway tidak dapat diproses.</p>
            </div>
            ...
            <div class="p-6 space-y-5">
                <div class="flex items-center justify-between pb-4 border-b border-zinc-100 dark:border-zinc-800">
                    <div>
                        ...
                        <div class="font-bold text-sm text-zinc-700 dark:text-zinc-300">Pakasir Payment Gateway</div>
                    </div>

                    <div class="text-right">
                        <div class="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">Status Transaksi</div>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-rose-100 text-rose-800 dark:bg-rose-950 dark:text-rose-300">
                            PENDING / DIBATALKAN
                        </span>
                    </div>
                </div>
                ...
                <div class="space-y-3 text-xs">
                    ...
                    <div class="p-3.5 rounded-2xl bg-rose-50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900/40 text-xs text-rose-800 dark:text-rose-300">
                        <p class="font-bold mb-0.5">Keterangan:</p>
                        <p class="text-[11px]">{{ $reason }}</p>
                    </div>
                </div>
            </div>
